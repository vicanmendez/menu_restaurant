                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <select name="order_type" 
                                        id="order_type" 
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    <option value="dine-in" {{ old('order_type', $order->order_type) === 'dine-in' ? 'selected' : '' }}>
                                        Para comer aquí
                                    </option>
                                    <option value="takeaway" {{ old('order_type', $order->order_type) === 'takeaway' ? 'selected' : '' }}>
                                        Para llevar
                                    </option>
                                </select>
                            </div>
                                        ...
                                        <div class="border rounded-lg p-4">
                                            <div class="flex justify-between items-start mb-2">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       value="{{ old('items.' . $dish->id . '.quantity', $quantity) }}"
                                                       min="0" 
                            ...
                            <div>
                                ...
                                <textarea name="special_instructions" 
                                          ...
                                          rows="3" 
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('special_instructions', $order->special_instructions) }}</textarea>
                            </div>
